...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            current_gain = score0 - last_score
            last_score_0 = score0
        else:
            current_gain = score1 - last_score
            last_score_0 = score1
        if current_gain > running_high:
            print(current_gain, 'point(s)! The most yet for Player', who)
            running_high_0 = current_gain
        else:
            running_high_0 = running_high
        return announce_highest(who, last_score_0, running_high_0)
